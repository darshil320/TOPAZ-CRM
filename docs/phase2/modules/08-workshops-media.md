# 08 — Workshops, allocation, media foundation (migrations 0023–0025)
...
## Files to touch
- migrations 0023-0025; api/workshops.py, media.py, production.py (allocate only), tasks/media.py (+include); dashboard production/allocate, admin workshops, components/Media*
